...
*** Crossup combos						      :combo:
    Crossup with jumpingMK, then MK.
...
*** SA1 corner juggle					  :combo:juggle:@sa1:
    In the corner, SA1 can be juggled with anotther SA1, EX Hadouken, HK Tatsumaki, HP Shoryuken or HK.
...
* TODO SA2 against urien middle screen unblockables?
* TODO Joudan Geri loop
