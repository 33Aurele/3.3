...
*** Punish Boomerang Raid (SA2)					 :punish:sa2:
    ...
    In the corner, you can't jump without getting hit. Get up so that the last hit is guarded, then HP Hayate.
...
*** Punish HP Uppercut						     :punish:
    ...
    Punish with HP Fukiage. If you do late, Dudley will cross up (keep that in mind for post Fukiage juggles).
...
*** Punish Shinryuken (SA2) with MP				 :punish:sa2:
** Makoto 							     :makoto:
